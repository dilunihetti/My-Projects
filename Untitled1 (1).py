...
def get_pie_chart(entered_site):
    if entered_site == 'ALL':
        pie_chart = px.pie(spacex_df, values='class', names='Launch Site', title="Success Launches for All Sites")
        return pie_chart
        ...
        pie_chart = px.pie(class_pie, values='class count', names='class', title="Success Launches for Site")
        return pie_chart
